...
\begin{table}[h!]
   ...
   \label{table:mag3} % Oznaka za sklicevanje
   \begin{tabular}{|c|c|c|}
   \hline
   8 & 1 & 6 \\ \hline
   3 & 5 & 7 \\ \hline
...
\begin{table}[ht]
   ...
   \label{table:loshu} % Oznaka za sklicevanje
   \begin{tabular}{|c|c|c|}
   \hline
   4 & 9 & 2 \\ \hline
   3 & 5 & 7 \\ \hline
...
\begin{table}[ht]
   \centering
   \caption{Kvadrat Kubera} % Napis nad tabelo
   \label{table:kubera} % Oznaka za sklicevanje
   \begin{tabular}{|c|c|c|}
   \hline
   23& 28 & 21 \\ \hline
   22& 24 & 26 \\ \hline
...
\begin{table}[h!]
   ...
   \label{table:stevila}
   \begin{tabular}{|l|c|c|c|c|c|c|} % Definicija stolpcev: | za navpične črte, l/c za levo/center
      \hline
